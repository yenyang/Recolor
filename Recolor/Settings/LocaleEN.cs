    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(Setting setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PaletteChooserBehaviorWhenSwitchingPrefab)), "Palette Chooser Behavior When Switching Prefab" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.PaletteChooserBehaviorWhenSwitchingPrefab)), "Changes the behavior of the Palette Chooser when Switching Prefabs. Do Not Change: Keeps Chosen Palettes. Reset: Sets all palette choices to None. Remember Previous: Records what palettes were chosen previously for each prefab in each save file and will default to that." },
