// <copyright file="MeshColorRecord.cs" company="Yenyang's Mods. MIT License">
...
namespace Recolor.Domain
{
    ...
    public struct MeshColorRecord : IBufferElementData, ISerializable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MeshColorRecord"/> struct.
        /// </summary>
        /// <param name="colorSet">set of three colors.</param>
        public MeshColorRecord(ColorSet colorSet)
        {
            m_ColorSet = colorSet;
        }
        ...
        public MeshColorRecord(MeshColor meshColor)
        {
            m_ColorSet = meshColor.m_ColorSet;
        }

        /// <summary>
        /// Evaluates whether the mesh color record equals a color set.
        /// </summary>
